...
impl Huya {
    ...
    pub async fn get_live(
        ...
        ret.insert(
            ...
            format!(
                "{} - {}",
                j.pointer("/data/0/gameLiveInfo/roomName")
                    .ok_or("json err")?
                    .as_str()
                    .ok_or("cannot convert to string")?,
                j.pointer("/data/0/gameLiveInfo/nick")
                    .ok_or("json err")?
                    .as_str()
                    .ok_or("cannot convert to string")?
            ),
        ...
        ret.insert(
            ...
            html_escape::decode_html_entities(format!(
                ...
                j.pointer("/data/0/gameStreamInfoList/0/sFlvUrl")
                    ...
                    .as_str()
                    .ok_or("cannot convert to string")?,
                j.pointer("/data/0/gameStreamInfoList/0/sStreamName")
                    .ok_or("json err")?
                    .as_str()
                    .ok_or("cannot convert to string")?,
                j.pointer("/data/0/gameStreamInfoList/0/sFlvUrlSuffix")
                    ...
                    .as_str()
                    .ok_or("cannot convert to string")?,
                j.pointer("/data/0/gameStreamInfoList/0/sFlvAntiCode")
                    .ok_or("json err")?
                    .as_str()
                    .ok_or("cannot convert to string")?,
            ).as_str()).to_string(),
